...
int N, M, sccID = 0, tiempo = 0, idx = -1;
int disc [10010], low [10010], sccNum [10010], inDegree [10010];
vector<int> oriAdjacency [10010], sccNodes [10010];
bool inStack [10010];
...
int main(){
    ...
    memset(sccNum, -1, sizeof(sccNum)); memset(inStack, false, sizeof(inStack));
    for(int i = 0; i < M; i++){
        int a, b; cin >> a >> b;
        oriAdjacency[b].pb(a);
    }
